...
private:
	...
	SDL_Texture* texture;
	std::unordered_map<SDL_Keycode, unsigned int> char_map;
...
public:
	FontMap(SDL_Texture* texture, std::unordered_map<SDL_Keycode, unsigned int> char_map,
			unsigned int w, unsigned int h);

	FontMap(std::string file_path, std::unordered_map<SDL_Keycode, unsigned int> char_map,
			unsigned int w, unsigned int h);
